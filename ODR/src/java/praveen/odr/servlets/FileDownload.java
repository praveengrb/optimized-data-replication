...
public class FileDownload extends HttpServlet {
    ...
    FilePlacingManager filesManager = new FilePlacingManager();
    /**
     *
     */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FilePlacing fileLocation = filesManager.getFilePlacedById(uniqueFileId);
            String locationOfFragments = (fileLocation != null
                    && fileLocation.getLocation() != null
                    && !fileLocation.getLocation().isEmpty()
                    && !fileLocation.getLocation().equalsIgnoreCase("")) ? fileLocation.getLocation() : "";
    ...
    public static String decryptMessage(NtruEncryptKey ntruKey, String cipherText, String id, int i, String server) throws NtruException, IOException {
        ...
        try {
            ...
            Random randomContent = new Random(data);
            Path aesFile = Paths.get(Constants.KEY_FILE_LOCATION + id + "aes" + i + Constants.TXT_FILE_EXTENSION);
            byte[] aesFileBytes = Files.readAllBytes(aesFile);
            wrappedAESKey = ntruKey.encrypt(aesFileBytes, randomContent);
