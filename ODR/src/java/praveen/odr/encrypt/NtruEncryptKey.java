...
public class NtruEncryptKey
{
     ...
     * @return 
     * @throws praveen.odr.encrypt.exceptions.ObjectClosedException 
     */
     ...
     * @return 
     * @throws praveen.odr.encrypt.exceptions.ObjectClosedException 
     * @throws praveen.odr.encrypt.exceptions.NoPrivateKeyException 
     */
     ...
     * @return 
     * @throws praveen.odr.encrypt.exceptions.ObjectClosedException 
     * @throws praveen.odr.encrypt.exceptions.PlaintextBadLengthException 
     */
    public byte[] encrypt(
        byte    message[],
        Random  prng)
