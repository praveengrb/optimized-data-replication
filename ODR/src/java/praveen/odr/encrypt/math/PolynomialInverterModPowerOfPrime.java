package praveen.odr.encrypt.math;
 ...
 * defined in the NTRU Cryptosystems Technical Report #14 "Almost Inverses and
 * Fast NTRU Key Creation".
 *
 * <p>
...
public class PolynomialInverterModPowerOfPrime extends PolynomialInverterModPrime {
     ...
     * _prime. The table should be initialized so that invModPrime[i] * i = 1
     * (mod prime) if the inverse of i exists, invModPrime[i] = 0 if the inverse
     * of i does not exist. This table should not be modified after it has been
