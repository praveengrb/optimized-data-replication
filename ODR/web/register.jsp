						...
						<li>
							<div class="container">
								...
								<div class="slide-caption">
									<h2 class="slide-title">Account Creation</h2>
...
%>
                                                                            Your Name <p class="wow fadeInRight"><input type="text" name="name" placeholder="Your name "></p>
											Email Address <p class="wow fadeInRight"><input type="email" name="eid" placeholder="Email id..."></p>
